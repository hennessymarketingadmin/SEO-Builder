...
class Brakes extends Component {
    ...
    render() {
        return (
            ...
            <p>Discription:</p>
            <p>{'Find great deals for your brakes service for your ' + this.props.year + ' ' + this.props.make + ' ' + this.props.model + ' at ' + this.props.dealer + ' located in ' + this.props.city + ' and metro area'}</p>
            <hr></hr>
            <input 
            ...
            <div className='contentHeaderContainer'>
                <h1 className='contentHeader'>{this.props.make + ' Brakes Service in ' + this.props.city}</h1>
                <p className='contentHeaderParagraph'>Schedule your Brakes Service & Repair appointment online now!</p>
            ...
            <p>{'<h1 class=\'contentHeader\'>' + this.props.make + ' Brakes Service in ' + this.props.city + '</h1>'}</p>
            <p>{'<p class=\'contentHeaderParagraph\'>Schedule your Brakes Service & Repair appointment online now!</p>'}</p>
