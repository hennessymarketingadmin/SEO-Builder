...
class Transmission extends Component {
    ...
    render() {
        return (
            ...
            <p>Discription:</p>
            <p>{'Find great deals for your Transmission Service for your ' + this.props.year + ' ' + this.props.make + ' ' + this.props.model + ' at ' + this.props.dealer + ' located in ' + this.props.city + ' and metro area'}</p>
            <hr></hr>
            <input 
            ...
            <div className='contentHeaderContainer'>
                <h1 className='contentHeader'>{this.props.make + ' Transmission Service in ' + this.props.city}</h1>
                <p className='contentHeaderParagraph'>Schedule your Transmission Service & Repair appointment online now!</p>
            ...
            <p>{'<h1 class=\'contentHeader\'>' + this.props.make + ' Transmission Service in ' + this.props.city + '</h1>'}</p>
            <p>{'<p class=\'contentHeaderParagraph\'>Schedule your Transmission Service & Repair appointment online now!</p>'}</p>
