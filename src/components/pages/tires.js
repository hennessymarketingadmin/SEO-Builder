...
class Tires extends Component {
    ...
    render() {
        return (
            ...
            <p>{'<h1 class=\'contentHeader\'>' + this.props.make + ' Tire Replacement in ' + this.props.city + '</h1>'}</p>
            <p>{'<p class=\'contentHeaderParagraph\'>Schedule your Tire Replacement & Repair appointment online now!</p>'}</p>
            ...
            <h1>Tire Replacement Content</h1>
